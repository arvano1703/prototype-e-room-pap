...
<body>
    <div class="container">
        ...
        <form id="bookingForm" method="POST" action="https://script.google.com/macros/s/AKfycbxt3Jcv53jxdY_zlz8fpRaa3QjMQj_4cZiTQjruOsVfTsxO1e1uiK1o9Ml56RG52ksF/exec">
        ...
        <form id="cancelForm" method="POST" action="https://script.google.com/macros/s/AKfycbxt3Jcv53jxdY_zlz8fpRaa3QjMQj_4cZiTQjruOsVfTsxO1e1uiK1o9Ml56RG52ksF/exec">
    ...
    <script>
        ...
        function loadBookings() {
            fetch("https://script.google.com/macros/s/AKfycbxt3Jcv53jxdY_zlz8fpRaa3QjMQj_4cZiTQjruOsVfTsxO1e1uiK1o9Ml56RG52ksF/exec")
            .then(response => {
                if (!response.ok) {
                    throw new Error(`HTTP error! Status: ${response.status}`);
                }
